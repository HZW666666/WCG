...
/*-----------------------------------------------------------*/
static void LED123(void *pvParameters) {
...
static void LED456(void *pvParameters) {
    pvParameters = pvParameters;
...
int main(void) {//2∏ˆLEDµ∆…¡À∏
    ...
    xTaskCreate(LED123, "led123", mainCHECK_TAKS_STACK_SIZE, NULL, mainCHECK_TASK_PRIORITY, NULL);
